...
// Modified for nRF24_multipro      ZG      2018-08-18
// ported from https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/Multiprotocol/CFlie_nrf24l01.ino
...
// Futaba only has 7 channels (3 aux channels)
// #define MAX_CPPM_AUX_CHANNELS 8
#define MAX_CPPM_AUX_CHANNELS 7-4
...
static uint8_t data_rate, cflie_rf_channel;
...
static void send_search_packet()
{
    ...
    set_rate_channel(data_rate, cflie_rf_channel);
...
static void cflie_init()
{
    ...
    NRF24L01_WriteReg(NRF24L01_05_RF_CH, cflie_rf_channel);        // Defined by model id
...
//     NRF24L01_WriteReg(NRF24L01_05_RF_CH, cflie_rf_channel); // reset packet loss counter
...
static uint8_t cflie_initialize_rx_tx_addr()
{
    ...
    // if (Model.fixed_id) {
    //     cflie_rf_channel = Model.fixed_id % 100;
...
{
    if(ppm[num]>=CHANNEL_MAX_100)
        return CHANNEL_MAX_100;
    if (ppm[num]<=CHANNEL_MIN_100)
